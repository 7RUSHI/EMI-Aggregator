...
import com.vrushi.emiaggregator.feature_onboard.presentation.ScreenEvents
            ...
            is OnboardEvents.OnPermissionResult -> {
                if (!event.isGranted) {
                    viewModelScope.launch {
                        _sharedFlow.emit(ScreenEvents.ShowSnackbar(event.permission, R.string.app_permissions_snackbar_message))
                    }
                }
            }
